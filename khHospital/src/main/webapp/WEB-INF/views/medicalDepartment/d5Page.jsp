	...
	<section id="outer">
        ...
        <section id="content">
            ...
            <div class="presentPage" id="ps01">
                <h2>- 소개</h2>
                <p id="ps01-1">
		         KH병원 소화기내과는 소화기 치료내시경분야의 국내 최고 권위자이신 센터장 조주영 교수님, 대장암 수술의 권위자이신 한준길 교수님을 필두로 많은 경험을 보유한 의료진들이 진료와 치료에 만전을 기하고 있습니다.
				<br>
				또한 정확하고 신속한 진료를 위해 국내 최초 올림푸스현미경 내시경 도입, 최신 영상증강내시경, 엔도플립, 고해상도 식도내압검사, 캡슐내시경, 이중풍선 소장내시경, 단일풍선 소장내시경 등 다양한 첨단 의료 장비를 사용합니다.
				<br>
				 KH 소화기병센터는 소화기 내과, 외과, 내시경실로 구성되어 있으며, 통합시스템을 통한 높은 수준의 진료 성과를 기대할 수 있습니다.
                </p>
            </div>
                	...
                	<div class="pbox">
	                    ...
	                    <div class="profile">
	                        <div class="doctor">
	                            ...
	                            <p class="medical_sub">소화기내시경, 역류성 식도염, 위염, 위궤양, 위암, 
	                                <br>염증성 및 과민성 대장질환, 대장암, 기타 위장관 질환, 간질환</p>
	                        </div>
	                        <div>
                    ...
                    <div class="pbox">
	                    ...
	                    <div class="profile">
	                        <div class="doctor">
	                            ...
	                            <div class="department">소화기외과</div>
	                            <div class="tag">전문분야</div>

	...
	<section id="outer">
        ...
        <section id="content">
            ...
            <div class="presentPage" id="ps01">
                <h2>- 소개</h2>
                <p id="ps01-1">
		                 신생아, 소아, 만 15세 이하 청소년을 대상으로 탈장, 선천성 기형(항문기형, 림프관종, 혈관 기형 등), 선천성 장 폐쇄, 영아 유문 협착, 소아 소화기질환, 
		                 소아 항문질환, 종양, 신생아의 외과적 질환 및 충수돌기염, 장중첩증과 같은 외과적 질환에 대해 진료합니다. 회복이 빠르고 수술 흉터를 최소화할 수 있는 최소침습수술도 
		                 선택 가능합니다.
                </p>
            </div>
            ...
            <div class="presentList" id="ps02">
                <div class="faq-content">
                	<div class="pbox">
	                    ...
	                    <div class="profile">
	                        <div class="doctor">
	                            <div class="doctorName">윤선아 교수</div>
	                            <div class="department">소아외과</div>
	                            <div class="tag">전문분야</div>
	                            <p class="medical_sub">선천성기형, 소아탈장, 항문직장기형, 거대결장증, 담관낭종, 담도폐쇄, 
	                            <br>십이지장/소장폐쇄, 식도폐쇄, 소아종양, 갑상선설골낭종, 설소대</p>
	                        </div>
	                        <div>
                    ...
                    <div class="pbox">
	                    ...
	                    <div class="profile">
	                        <div class="doctor">
	                            ...
	                            <div class="doctorName">곽중하 교수</div>
	                            <div class="department">소아외과</div>
	                            <div class="tag">전문분야</div>
	                            <p class="medical_sub">소아탈장, 항문직장기형, 거대결장증, 담도폐쇄, 십이지장/소장폐쇄,
	                            <br>소아종양, 갑상선설골낭종, 설소대</p>
	                        </div>
	                        <div>

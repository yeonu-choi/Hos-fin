	...
	<section id="outer">
        ...
        <section id="content">
            ...
            <div class="presentPage" id="ps01">
                <h2>- 소개</h2>
                <p id="ps01-1">
		                   로봇수술은 2차원 영상으로 수술 부위를 볼 수 있는 기존의 복강경 수술과 달리, 수술부위를 15배 크기로 확대한 고화질의 3차원 영상으로 구현되어 장기, 혈관, 신경 등 
		                   해부학적인 구조물들을 정확히 확인할 수 있어 정밀하고 정확한 수술이 가능한 것이 특징입니다. 기존의 복강경 수술은 기구가 직선형이고 기구의 끝은 단순한 움직임만 가능한 고정된 형태여서 움직이는 각도가 제한돼 몸의 깊은 곳을 수술하는데 어려움이 있었습니다. 
		                   하지만 다빈치 로봇은 뛰어난 인체 공학적인 기구로 사람의 손과 팔처럼 자유자재로 움직일 수 있을 뿐만 아니라 손떨림 현상이 전혀 없고 양손을 자유자재로 사용할 수 있기 때문에 몸 깊숙한 곳의 수술에도 용이합니다.
		         <br>
		                   이 때문에 다빈치 로봇수술은 기존의 복강경 수술과 비교해 입원 기간이 짧고 수술 후 흉터가 거의 없으며, 수술 후 통증이 매우 적어 회복 속도가 빠를 뿐만 아니라 수술 중 발생할 수 있는 혈관이나 신경의 손상 등 합병증이 현저히 적어 현대 의학에서 각광을 받고 있는 수술입니다. 
		                   이러한 장점으로 다빈치 로봇은 국내는 물론 전 세계적으로 활발히 사용되고 있습니다. 특히 배꼽을 통한 단일공 로봇수술은 수술 흉터가 거의 없어 수술 후 환자의 수술 만족도를 높였습니다. 
		                   수술 후에도 상처가 거의 보이지 않아 흉터에 대한 부담감이 거의 없으며 집도의의 손 떨림을 막아주는 정교한 로봇 팔의 움직임으로 정상조직의 손상이 적어 기존의 복강경 수술에 비해 통증 역시 적습니다. 
		                   입원기간이 짧아 일상생활로의 복귀 역시 빠릅니다.
                </p>
            </div>
            ...
            <div class="presentList" id="ps02">
                <div class="faq-content">
                	<div class="pbox">
	                    ...
	                    <div class="profile">
	                        <div class="doctor">
	                            <div class="doctorName">김윤철 교수</div>
	                            <div class="department">로봇수술센터</div>
	                            <div class="tag">전문분야</div>
	                            <p class="medical_sub">단일공을 비롯한 복강경 수술, 다빈치 로봇수술, 로봇수술</p>
	                        </div>
	                        <div>
                ...
                <div class="faq-content">
                	<div class="pbox">
	                    ...
	                    <div class="profile">
	                        <div class="doctor">
	                            <div class="doctorName">임지혜 교수</div>
	                            <div class="department">로봇수술센터</div>
	                            <div class="tag">전문분야</div>
	                            <p class="medical_sub">단일공을 비롯한 복강경 수술, 다빈치 로봇수술, 로봇수술</p>
	                        </div>
                ...
                <div class="faq-content">
                	<div class="pbox">
	                    ...
	                    <div class="profile">
	                        <div class="doctor">
	                            <div class="doctorName">김민중 교수</div>
	                            <div class="department">로봇수술센터</div>
	                            <div class="tag">전문분야</div>
	                            <p class="medical_sub">단일공을 비롯한 복강경 수술, 다빈치 로봇수술, 로봇수술<br>

	...
	<section id="outer">
        ...
        <section id="content">
            ...
            <div class="presentPage" id="ps01">
                <h2>- 소개</h2>
                <p id="ps01-1">
		                  순환기 내과는 고혈압, 고지혈증, 관상동맥질환 (협심증, 심근경색증), 대동맥 질환, 심부전증, 심장판막질환, 부정맥, 말초혈관질환 등에 대한 진료 및 치료를 합니다.
				<br>
				이러한 질환을 심전도 (운동부하심전도, 24시간 활동심전도), 24시간 혈압검사, 말초혈관 동맥경화 검사, 경동맥 초음파, 심장초음파, 심장혈관 CT 등의 검사를 통하여 신속하고 정확히 진단합니다.
				<br>
				금식이 필요한 심장혈관 CT를 제외하고는, 이 모든 검사가 진료 당일 가능하며, 검사 후 바로 결과를 상담할 수 있습니다.
				<br>
				임신 중 순환기 질환에 대한 전문적 관리
				산부인과 및 다른 내과 분과와의 연계를 통해 고위험 산모와 심장질환이 있는 산모, 그리고 고혈압 산모의 임신 전, 중, 후 관리 및 치료를 보다 체계적으로 할 수 있습니다.
                </p>
            </div>
            ...
            <div class="presentList" id="ps02">
                <div class="faq-content">
                	<div class="pbox">
	                    ...
	                    <div class="profile">
	                        <div class="doctor">
	                            <div class="doctorName">강훈 교수</div>
	                            <div class="department">순환기내과</div>
	                            <div class="tag">전문분야</div>
	                            <p class="medical_sub">호흡기, 기관지천식, 미만성간질성폐질환, 면역성폐질환, 폐종양</p>
	                        </div>
	                        <div>

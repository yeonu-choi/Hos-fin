	...
	<section id="outer">
        ...
        <section id="content">
            ...
            <div class="presentPage" id="ps01">
                <h2>- 소개</h2>
                <p id="ps01-1">
		         소화기내시경센터는 내시경을 이용한 각종 소화기질환의 진단과 치료를 담당합니다.
			<br>
			세부적으로는 상부위장관검사실, 하부장관검사실, 치료내시경실, 초음파내시경검사실, 췌담도 내시경검사실, 소화관운동기능 검사실로 구성되어 있습니다.
			<br>
			조기위암에 대한 내시경 수술, 대장종양에대한 내시경 절제술, 췌담도 내시경 및 중재적 내시경 초음파 시술 분야에서 우리 나라를 주도하고 있으며, 치료에 따른 결과 또한
			매우 우수합니다.
			<br>
			KH병원 소화기내시경센터는 환자들이 좀 더 편리하게 최상의 진료를 받을 수 있도록
			끊임없이 노력하겠습니다.
                </p>
            </div>
            ...
            <div class="presentList" id="ps02">
                <div class="faq-content">
                	<div class="pbox">
	                    ...
	                    <div class="profile">
	                        <div class="doctor">
	                            <div class="doctorName">박도형 교수</div>
	                            <div class="department">소화기내시경센터</div>
	                            <div class="tag">전문분야</div>
	                            <p class="medical_sub">	소화기내과,소화기내시경센터,암병원,대장암센터</p>
	                        </div>
	                        <div>
                ...
                <div class="faq-content">
                	<div class="pbox">
	                    ...
	                    <div class="profile">
	                        <div class="doctor">
	                            <div class="doctorName">김대영 교수</div>
	                            <div class="department">소화기내시경센터</div>
	                            <div class="tag">전문분야</div>
	                            <p class="medical_sub">소화기내과,담도ㆍ췌장센터,소화기내시경센터,암병원,담도 및 췌장암센터</p>
	                        </div>
	                        <div>

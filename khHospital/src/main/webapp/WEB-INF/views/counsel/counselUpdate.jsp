...
<body>
	<c:set var="c_content" value="${c.c_content}"/>
    ...
    <div id="writeArea">
        <form id="modifyForm" action="${ contextPath }/counsel/modify" method="post" enctype="multipart/form-data">
            <table id="writeTable" style="border-collapse: collapse;" align="center">
                ...
                <tr class="general">
                    ...
                    <td><input type="text" id="ctitle" name="ctitle" value="${c.ctitle}"></td>
                </tr>
                <tr id="content">
                ...
                <tr class="general">
                    <td class="bold" width="20%">현재 첨부파일</td>
                    <td>
                ...
                <tr class="general">
                    <td class="bold" width="20%">첨부파일 1 수정</td>
                    <td>
                        <div class="fArea">
                ...
                <tr class="general">
                    <td class="bold" width="27%">첨부파일 2 수정</td>
                    <td>
                        <div class="fArea">
            ...
            <div id="chkArea">
            	...
            	<input type="hidden" name="did" value="${c.did}">
    ...
    <script>
    	window.onload = function(){
    		var con = "${c_content}";
    		var conArea = document.getElementById("content2");
    		
    		if(con.indexOf('<br/>') !== -1){
    			var rep = con.replace(/(<br>|<br\/>|<br \/>)/g, '\r\n');
        		conArea.value = rep;
    		} else {
    			conArea.value = con;
    		}

...
<body>
    ...
    <div id="cArea">
        <p id="cTitle">본인인증</p>
        <p id="cSub">고객님 명의로 등록된 휴대폰 번호를 통해 본인 인증 과정을 거치게 됩니다.</p>
        <button id="verifyBtn" onclick="showConfirm();">휴대폰 인증</button>
    </div>
    <div class="joinArea">
        ...
        <table id="join" style="border-collapse: collapse;" align="center">
            ...
            <tr>
                ...
                <td><input type="text" id="un" name="userName" placeholder="본인 인증 후 자동 입력됩니다." readonly></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="tel" id="ph" name="phone" placeholder="본인 인증 후 자동 입력됩니다." readonly></td>
            </tr>
            <tr>
                <th width="20%" height="80px"><span class="empa">* </span>이메일</th>
                <td><input type="email" id="in3" name="email">
                    <p class="innerText">이메일 주소는 아이디@서비스 홈페이지입니다. 예) kh_hospital@iei.or.kr</p></td>
            </tr>
        </table>
        <script>
            function showConfirm(){
            	...
            	window.open("${ contextPath }/member/confirm","본인인증", options);
            }

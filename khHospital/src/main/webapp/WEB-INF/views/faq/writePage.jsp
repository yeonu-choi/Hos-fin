	...
	<section id="outer">
        ...
        <div id="content">
            <div class="insertArea">
                <form action="${contextPath }/faq/insert" method="POST" id="writeFaq">
                <select name="did">
                ...
                <input type="text" name="ftitle" id="f_title" placeholder="제목을 입력하세요." required>
                <textarea name="fcontent" style="resize:none;" required></textarea>
                <div id="btnArea">

...
<body>
    ...
    <div id="mainMenu">
        <div id="MenuArea">
            <ul class="mainMenu">
                <li class="main1" onclick="" onmouseover="HideSub();">진료과/의료진</li>
        ...
        <div id="subMenu">
            ...
            <div id="subArea02">
                <ul class="sub02">
                    ...
                    <li id="coun" onmouseover="HideSsub();"><a href="">1:1 전문의 상담</a>&nbsp;&nbsp;&nbsp;</li>
                </ul>
            </div>
            <div id="sub-subArea3">
                <ul class="sub-sub3">
                    <li><a href="">예약 안내</a>&nbsp;&nbsp;&nbsp;</li>
                    <li><a href="">빠른 예약</a>&nbsp;&nbsp;&nbsp;</li>
                    <li><a href="">온라인 예약</a>&nbsp;&nbsp;&nbsp;</li>
                </ul>
            </div>
            <div id="sub-subArea4">
                <ul class="sub-sub4">
                    <li><a href="">빠른 예약 조회</a>&nbsp;&nbsp;&nbsp;</li>
                    <li><a href="">온라인 예약 조회</a>&nbsp;&nbsp;&nbsp;</li>
                </ul>
            </div>
            <div id="subArea03">
                <ul class="sub03">
